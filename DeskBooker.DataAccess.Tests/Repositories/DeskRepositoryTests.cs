...
namespace DeskBooker.DataAccess.Repositories
{
  public class DeskRepositoryTests
  {
    ...
    public void ShouldReturnTheAvailableDesks()
    {
      ...
      {
        context.Desk.Add(new Desk { Id = 1, Description = "Desk 1" });
        context.Desk.Add(new Desk { Id = 2, Description = "Desk 2" });
        context.Desk.Add(new Desk { Id = 3, Description = "Desk 3" });

        context.DeskBooking.Add(new DeskBooking { DeskId = 1, Date = date, FirstName = "", LastName = "", Email = "", Id = 1});
        context.DeskBooking.Add(new DeskBooking { DeskId = 2, Date = date.AddDays(1), FirstName = "", LastName = "", Email = "", Id = 2 });
    ...
    public void ShouldGetAll()
    {
      ...
      var storedList = new List<Desk>
      {
        ...
        new Desk { Id = 3, Description = "Desk 3" }
      };
